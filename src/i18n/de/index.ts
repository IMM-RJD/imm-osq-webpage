export default {
  ...
  concept_p_third:
    '„Ein Netzwerk braucht Individuen, Individuen brauchen Netzwerke.“',
  // event page
  ...
  gallery_subheadline: 'Deutsch gallery_subheadline',
  // project
  project_headline: 'Vergangene Projekte',
  project_timeline_project3_title: 'Deutsch project_timeline_project3_title',
  project_timeline_project3_description_first:
    'Deutsch project_timeline_project3_description_first',
  project_timeline_project3_description_second:
    "Deutsch Lorem Impsum {'|'}{'|'} Ipsum Lorem",
  project_timeline_project2_title: 'Deutsch project_timeline_project2_title',
  project_timeline_project1_title: 'Deutsch project_timeline_project1_title',
  project_timeline_project1_title_subtitle:
    'Deutsch project_timeline_project1_title_subtitle',
  project_timeline_project1_description_first:
    'Deutsch project_timeline_project1_description_first',
  project_timeline_project1_description_second:
    'Deutsch project_timeline_project1_description_second.',
  // contact
